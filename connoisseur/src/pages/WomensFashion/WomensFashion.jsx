...
const WomensFashion = () => {
  ...
  return (
    <div className="font-merriweather-regular">
      ...
      <h3 className="text-center font-bold text-xl text-women1 max-sm:mb-[-4rem] font-merriweather-regular">
        CHECK ALL THE NEW ARRIVALS
      </h3>
      <div className="flex justify-center my-3 max-sm:mt-[5rem] max-sm:mb-[-3rem]">
        <button
          className="mr-2 bg-women2 hover:bg-women3 text-white font-bold py-2 px-4 rounded"
      ...
      <div className="grid lg:grid-cols-4 gap-3 lg:mt-3 mt-[5rem] grid-cols-2">
        {(sortType && sortedProducts.length > 0
          ...
          <Card
            ...
            buttonBgColor="bg-women2" // Custom background color for the button
            buttonTextColor="text-white"
            cardBgColor="bg-pink-200"
            priceColor="text-women2"
            titleColor="text-women2"
            ratingColor="text-women2"
          />
        ))}
      </div>
      <div className=" text-center mt-4 flex flex-col mb-2   w-[full] h-[20vh] text-women2 items-center max-sm:text-lg max-sm:h-fit  ">
        ...
        <Button
          className="font-sans font-thin py-2 px-4 bg-women2 w-fit max-sm:mt-0 max-sm:py-2 max-sm:px-1 text-tertiary mt-2 hover:bg-women3"
